...
const arrowsHTML = `<img src="/legacy/images/heroicons-chevron-right.svg" class="path path-icon ellipsis"><img src="/legacy/images/heroicons-chevron-down.svg" class="path path-icon arrow">`;
            ...
            <section class="navlink-container">
                <section class="notextmargin">
                    <details id="site-tree_${index++}" class="site-tree-directory" open>
                        <summary><img src="/legacy/images/heroicons-chevron-right.svg" class="path path-icon ellipsis"><img src="/legacy/images/heroicons-chevron-down.svg" class="path path-icon arrow"><a class="no-underline" href="https://neocities.org/site/bscit" target="_blank"><b>root</b><span class="path">/</span></a><span class="ellipsis path">...</span></summary>
                        <ul>
                            <details id="site-tree_${index++}" class="site-tree-directory" open>
                                <summary><img src="/legacy/images/heroicons-chevron-right.svg" class="path path-icon ellipsis"><img src="/legacy/images/heroicons-chevron-down.svg" class="path path-icon arrow"><a class="no-underline" href="/legacy/"><b>bscit.dev</b><span class="path">/</span></a><span class="ellipsis path">...</span></summary>
                                <ul>
                                    ${construct(parse(fileList, "/legacy/"))}
                                </ul>
                            </details>
                        </ul>
                    </details>
